    ...
    $(function() {
        $.get("{{ route('api_gettinh') }}", function( data ) {
            ...
            data_tinh.forEach(tinh => {
                html_option.push('<option value="'+ convert_id(tinh.matp, 1) +'">'+ tinh.name +'</option>');
            });
            // Set HTML
            ...
            if(this_tinh.val() != 0) {
                ...
                .done(function( data ) {
                    ...
                    data_huyen.forEach(huyen => {
                        html_option.push('<option value="'+ convert_id(huyen.maqh, 2) +'">'+ huyen.name +'</option>');
                    });
                    // Set HTML
        ...
        $('#inputGroupSelectHuyen').change(function() {
            ...
            if(this_huyen.val() != 0) {
                ...
                .done(function( data ) {
                    ...
                    data_xa.forEach(xa => {
                        html_option.push('<option id="xa-'+ convert_id(xa.xa_id, 4) +'" value="'+ convert_id(xa.xa_id, 4) +'">'+ xa.name +'</option>');
                    });
                    // Set HTML
        ...
        function convert_id(val, number) {
            if(val < (Math.pow(10, number))){
                val = '' + val;
                number = number - val.length + 1;
